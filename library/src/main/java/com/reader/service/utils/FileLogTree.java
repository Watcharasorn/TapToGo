...
public class FileLogTree extends Timber.Tree {
    ...
    private class FileLogHandler extends Handler {
        ...
        //@NonNull
        private void doWrite(LogMsgBean msgBean) {
...
//                    Log.d("LogPath", file.getPath());
    ...
    //2017.08.28 04:41:09.022,VERBOSE/MainActivity,watch the tag hehe @NonNull
    private String produceLogInfo(LogMsgBean msgBean) {
